...
describe('Sanatize room for client', function() {
  it('should convert _members object to array of userids', function() {
    ...
    Room.sanatize(testPublicRoom, function(sanatizedRoom) {
      correctlySanatizedRoom.id = sanatizedRoom.id;

      expect(sanatizedRoom.members).to.eql(correctlySanatizedRoom.members);
    })
  })
});
