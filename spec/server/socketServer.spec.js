...
describe('Chat server', function() {
  ...
  describe('authentication', function() {
    ...
    it('should be successful with a valid key', function(done) {
    ...
    it('should send a list of rooms with membership to the client', function(done) {
      socket.emit('authenticate', data);
      socket.on('membershipUpdate', function(data) {
        var rooms = data.rooms;
        expect(typeof rooms == 'array').toBe(true);
        done();
      })
    })
  })
